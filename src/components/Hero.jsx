          ...
          {data.data.map(anime => {
            ...
            return (
              <div key={anime.id}>
                <div
                  style={{
                    backgroundImage: `url(${coverImage ? coverImage.original : posterImage.original})`,
                  }}
                  className="bg-cover bg-center"
                >
                  <div className="flex flex-col gap-7 pt-36 pb-16 px-8 bg-gradient-to-r from-black from-25% bg-black bg-opacity-10">
                    <div>
                      <h1 className="text-6xl font-semibold text-balance">
          ...
          >
            <div className="flex flex-col gap-7 pt-36 pb-16 px-8 bg-gradient-to-r from-black bg-black bg-opacity-10">
              ...
              <p className="max-w-[60ch] text-balance">
                ...
                monstros que ameaçam seu lar. Mesmo depois de derrotar a Titã
                Fêmea, Eren não consegue descansar - uma horda de Titãs se
                aproximam da Muralha Rose e a batalha em nome da humanidade
                continua!
              </p>
              <div className="flex gap-5">
                <Button type="button" icon={iconPlay}>
